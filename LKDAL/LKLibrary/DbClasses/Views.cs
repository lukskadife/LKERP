...
{
    [Table(Name = "vNumuneTalepleri")]
    public class vNumuneTalepleri : IDisposable
    {
        ...
        [Column]
        public string FuarKodu { get; set; }
        ...
        public tblNumuneTalepleri ViewToTbl()
        {
            return new tblNumuneTalepleri()
            {
                Id = this.Id,
                NumuneId=this.NumuneId,
                Miktar = this.Miktar,
                MusteriId=this.MusteriId,
                YeniMusteriAdi = this.MusteriAdi,
                FuarId = this.FuarId,
                TalepTarihi=DateTime.Now,
                GonderildiMi=this.GonderildiMi,
    ...
    [Table(Name = "vNumuneKumaslar")]
    public class vNumuneKumaslar : IDisposable
    {
        [Column(Name = "Id", IsDbGenerated = true, IsPrimaryKey = true)]
        public int Id { get; set; }
        ...
        public string TrCodeAdi { get; set; }
        ...
        public tblNumuneKumaslar ViewToTbl()
        {
            return new tblNumuneKumaslar()
             {
                 Id = this.Id,
                 TipId = this.TipId,
                 Barkod=this.Barkod,
                 ...
                 RenkNo = this.RenkNo,
                 FasonIslemKodu = this.FasonIslemKodu,
                 Koleksiyon = this.Koleksiyon,
                 Miktar = this.Miktar,
                 BirimId = this.BirimId,
                 TrCode = this.TrCodeId,
                 FuarId = this.FuarId,
                 Aciklama = this.Aciklama,
                 EkleyenKullaniciId = this.EkleyenKullaniciId,
                 SonDegistirenKullaniciId = this.SonDegistirenKullaniciId,
                 EklenmeTarihi = this.EklenmeTarihi,
                 KafesNo = this.KafesNo,
                 KafesAltNo = this.KafesAltNo,
                 KafesSiraNo = this.KafesSiraNo,
                 Finish = this.Finish
             };
        }

        public tblNumuneKumaslarBarkodlu ViewToTblBarkodlu()
        {
            return new tblNumuneKumaslarBarkodlu()
            {
                Id = this.Id,
    ...
    [Table(Name = "vFuarlar")]
    public class vFuarlar : IDisposable
    {
        [Column(Name = "Id", IsDbGenerated = true, IsPrimaryKey = true)]
        public int Id { get; set; }
        ...
        public tblFuarlar ViewToTbl()
        {
            return new tblFuarlar()
            {
                Id = this.Id,
                Kodu = this.Kodu,
                Adi = this.Adi,
                FuarTarihleri = this.FuarTarihleri,
                FuarBaslangicTarihi=this.FuarBaslangicTarihi,
                FuarYili=this.FuarYili,
                HallNo=this.HallNo,
