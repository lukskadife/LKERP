...
namespace WcfService1.Classes
{
    ...
    public class tblMakinalar : IDisposable
    {
        ...
        [Column]
        public double? GunlukDokuma { get; set; }
    ...
    public class tblBelgeNo : IDisposable
    {
        ...
        {
            tblBelgeNo belgeNo = new DBEvents().GetGeneric<tblBelgeNo>(c => c.Tipi == tipi).FirstOrDefault();
    ...
    public class tblProses : IDisposable
    {
        ...
        public static List<tblProses> ProsesleriGetir()
        {
    ...
    [Table(Name = "tblFormlar")]
    public class tblFormlar : IDisposable
    {
        [Column(Name = "Id", IsDbGenerated = true, IsPrimaryKey = true)]
        public int Id { get; set; }
