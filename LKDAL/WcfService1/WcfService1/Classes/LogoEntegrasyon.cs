...
namespace WcfService1.Classes
{
    ...
    public class LogoEntegrasyon
    {
        ...
        public int MalzemeleriEntegreEt()
        {
            ...
            {
                tblMalzemeler malzeme = new tblMalzemeler()
                {
                    Adi = logoMalzeme.Adi,
                    AktifMi = logoMalzeme.AktifMi == 0 ? true : false,
                    BaglantiId = logoMalzeme.Tip.Value,
                    Id = logoMalzeme.Id,
                    EntId = logoMalzeme.LogoId,
                    Kodu = logoMalzeme.Kodu
                };
