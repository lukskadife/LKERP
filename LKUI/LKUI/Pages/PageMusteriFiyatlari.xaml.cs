...
namespace LKUI.Pages
{
    ...
    public partial class PageMusteriFiyatlari : UserControl
    {
        ...
        private void BtnEkle_Click(object sender, RoutedEventArgs e)
        {
            ...
            (DGridMusteriFiyatListesi.ItemsSource as List<vFiyatListeleri>).Add(new vFiyatListeleri() { Dovizler = ListDoviz, Yil = Convert.ToInt32((ComboBoxYil.SelectedValue as ComboBoxItem).Content), Ay = ComboBoxYil.SelectedIndex  });
            DGridMusteriFiyatListesi.Items.Refresh();
        }
    }
}
