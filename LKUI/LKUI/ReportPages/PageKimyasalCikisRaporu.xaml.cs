...
{
    /// <summary>
    /// Interaction logic for PageKimyasalCikisRaporu.xaml
    /// </summary>
    public partial class PageKimyasalCikisRaporu : UserControl
    {
        public PageKimyasalCikisRaporu()
        {
            InitializeComponent();
        }
        ...
        private void BtnRaporla_Click(object sender, RoutedEventArgs e)
        {
            ...
            DGridRapor.ItemsSource = Rapor.KimyasalCikisRaporuGetir(DateIlkTarih.SelectedDate.Value, DateSonTarih.SelectedDate.Value);
        ...
        {
            DGridRapor.ToExcel<vKimyasalCikisRaporu>();
        }
    }
}
