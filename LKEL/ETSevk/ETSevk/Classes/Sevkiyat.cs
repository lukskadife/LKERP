...
namespace ETSevk.Classes
{
    public class Sevkiyat
    {
        ...
        private List<vPaketListesi> SevkiyatBrutleriHesapla_PaleteGore(List<vPaketListesi> paketListesi, SevkiyatPaketTip paketTipi)
        {
            ...
            while (ind < paketListesi.Count)
            {
                ...
                if (paketTipi == SevkiyatPaketTip.Palet9Buyuk || paketTipi == SevkiyatPaketTip.Palet9Kucuk)
                {
                    ...
                    tmpList.ForEach(c => c.BrutKg = c.Kg + brutKutuAgirlik);
        ...
        public enum SevkiyatPaketTip { Sandik160, Sandik180, Palet9Kucuk, Palet9Buyuk, Palet12Kucuk, Palet12Buyuk };
        public List<vPaketListesi> SevkiyatListesiGetir(SevkiyatPaketTip secilenTip)
        {
            ...
            if (secilenTip == SevkiyatPaketTip.Sandik160 || secilenTip == SevkiyatPaketTip.Sandik180)
            {
                ...
                list.ForEach(c => c.BrutKg = c.Kg + sandikAgirlik);
            }
        ...
        public vPaketListesi KutuGetir(int kutuId)
        {
            return db.GetGeneric<vPaketListesi>(c => c.KutuId == kutuId).FirstOrDefault();
        }
