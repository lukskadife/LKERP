...
namespace ETSevk.Classes
{
    public class DBEvents : IDisposable
    {
        ...
        public DBEvents()
        {
            //_connStr = "Data Source=ISD_01\\SQLEXPRESS2012;Initial Catalog=LKDB;User ID=sa;Password=isd";
            _connStr = "Data Source=SERVER;Initial Catalog=LKDB;User ID=Sa;Password=SaLuks123";
            //_connStr = @"Data Source=77.79.121.145\ISDSQLSRV;Initial Catalog=LKDB;User ID=isdtest;Password=isdtest";
            //_connStr = "Data Source=SERVER;Initial Catalog=LKDBT;User ID=Sa;Password=Sa123";
        }
